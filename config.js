...
const CONFIG = {
  ...
  accounts: {
    groom: [
      { role: "신랑", name: "이기태", bank: "새마을금고", number: "9002-1825-7185-2" },
      { role: "어머니", name: "김해경", bank: "OO은행", number: "000-000-000000" }
    ],
    bride: [
      { role: "신부", name: "박영혜", bank: "하나은행", number: "228-910298-19807" },
      { role: "아버지", name: "박량규", bank: "OO은행", number: "000-000-000000" },
      { role: "어머니", name: "최경자", bank: "OO은행", number: "000-000-000000" }
    ]
  },
